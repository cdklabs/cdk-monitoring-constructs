...
test("snapshot test: no alarms", () => {
    ...
    const dummyApi = new GraphqlApi(stack, "testHttpApi", {
        name: "DummyApi",
        schema: SchemaFile.fromAsset(path.join(__dirname, "..", "..", "assets", "schema.graphql")),
    });
...
test("snapshot test: no alarms with imported IGraphqlApi", () => {
    ...
    const dummyApi: IGraphqlApi = GraphqlApi.fromGraphqlApiAttributes(scope, "ImportedGraphQlApi", {
