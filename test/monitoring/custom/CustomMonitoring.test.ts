...
import {ComparisonOperator, LegendPosition, MathExpression, Metric, Shading} from "aws-cdk-lib/aws-cloudwatch";

import {AxisPosition, CustomMonitoring, GraphWidgetType, MetricFactory, MetricStatistic} from "../../../lib";
    ...
    const monitoring = new CustomMonitoring(scope, {
        ...
        metricGroups: [
            ...
            },
            {
                ...
                horizontalRightAnnotations: [{label: "DummyAnnotation3", value: 20, fill: Shading.BELOW}],
...
test("throws error if attempting to add both a regular alarm and an anomoly detection alarm", () => {
    ...
    ).toThrow("Adding both a regular alarm and an anomaly detection alarm at the same time is not supported");
});
