...
test("snapshot test: no alarms", () => {
    ...
    new LambdaFunctionMonitoring(scope, {
        lambdaFunction: Function.fromFunctionAttributes(stack, "DummyFunctionRef", {
            functionArn: "arn:aws:lambda:us-west-2:123456789012:function:DummyFunctionRef",
        }),
    });
    ...
    const monitoring = new LambdaFunctionMonitoring(scope, {
        ...
        addLowTpsAlarm: {
            Warning: {
                minTps: 0,
                datapointsToAlarm: 1,
                comparisonOperatorOverride: ComparisonOperator.LESS_THAN_OR_EQUAL_TO_THRESHOLD,
            },
        },
        addHighTpsAlarm: {
            Warning: {
