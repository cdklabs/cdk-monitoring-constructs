...
import {AlarmWithAnnotation, StepFunctionServiceIntegrationMonitoring} from "../../../lib";
...
test("snapshot test: no alarms", () => {
    ...
    const monitoring = new StepFunctionServiceIntegrationMonitoring(scope, {
        ...
        serviceIntegrationResourceArn: "arn:aws:states:eu-west-1:216854468193:batch:submitJob.sync",
    });
