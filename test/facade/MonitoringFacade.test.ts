...
import {DefaultDashboardFactory, DynamicDashboardFactory, MonitoringFacade, SingleWidgetDashboardSegment} from "../../lib";
...
describe("test of defaults", () => {
    ...
    test("handles dynamic dashboards", () => {
        ...
        const dynamicDashboardFactory = new DynamicDashboardFactory(stack, "TestDynamicDashboardFactory", {
    ...
    test("SingleWidgetDashboardSegment is not displayed if addSegment overrides set to false", () => {
        ...
        const stack = new Stack();
        const dashboardFactory = new DefaultDashboardFactory(stack, "TestDashboardFactory", {
            dashboardNamePrefix: "testPrefix",
        ...
        facade.addSegment(new SingleWidgetDashboardSegment(new TextWidget({markdown: "Simple Dashboard Segment"})), {
