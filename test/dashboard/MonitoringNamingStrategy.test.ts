...
test("string with spaces is not alarm friendly", () => {
    expect(MonitoringNamingStrategy.isAlarmFriendly("This is not valid")).toBeFalsy();
});

test("string with comma is not alarm friendly", () => {
    expect(MonitoringNamingStrategy.isAlarmFriendly("This,Is,Not,Friendly")).toBeFalsy();
});

test("this string is alarm friendly", () => {
    expect(MonitoringNamingStrategy.isAlarmFriendly("This_is__Valid-Alarm-Name")).toBeTruthy();
});
...
test("for empty naming strategy, all outputs are undefined", () => {
    ...
    expect(() => stack.resolve(namingStrategy.resolveHumanReadableName())).toThrowError(
    ...
    expect(() => stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toThrowError(
...
test("fallback name only (alarm friendly)", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("FallbackName_AlarmFriendly");
    expect(stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toEqual("FallbackName_AlarmFriendly");
});
...
test("fallback name only (not alarm friendly)", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("--- not friendly ---");
    expect(() => stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toThrowError(
        "Insufficient information provided for naming the alarms and/or monitoring section: " +
            "Please provide alarmFriendlyName, humanReadableName, or namedConstruct as a fallback",
    );
...
test("fallback to construct (alarm friendly ID)", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("DummyConstructId");
    expect(stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toEqual("DummyConstructId");
});
...
test("fallback to construct (not alarm friendly ID)", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("Not Alarm Friendly!!!");
    expect(() => stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toThrowError(
        "Insufficient information provided for naming the alarms and/or monitoring section: " +
            "Please provide alarmFriendlyName, humanReadableName, or namedConstruct as a fallback",
    );
...
test("should use node ID for non-named DDB", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("TableId");
    expect(stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toEqual("TableId");
});
...
test("should use table name for named DDB when defined as fallback", () => {
    ...
    expect(stack.resolve(namingStrategy.resolveHumanReadableName())).toEqual("TableName");
    expect(stack.resolve(namingStrategy.resolveAlarmFriendlyName())).toEqual("TableName");
});
