import {Alarm, CfnAlarm, CreateAlarmOptions, MathExpression, MathExpressionOptions, MathExpressionProps} from "aws-cdk-lib/aws-cloudwatch";
...
export class AnomalyDetectionMathExpression extends MathExpression {
    ...
    createAlarm(scope: Construct, id: string, props: CreateAlarmOptions): Alarm {
        ...
        (cfnAlarm.metrics as CfnAlarm.MetricDataQueryProperty[]).forEach((metric, index) => {
