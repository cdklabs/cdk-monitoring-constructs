...
export class TpsAlarmFactory {
    ...
    addMinTpsAlarm(metric: MetricWithAlarmSupport, props: LowTpsThreshold, disambiguator?: string) {
    ...
    addMaxTpsAlarm(metric: MetricWithAlarmSupport, props: HighTpsThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
