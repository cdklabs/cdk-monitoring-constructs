...
export class AgeAlarmFactory {
    ...
    addDaysToExpiryAlarm(metric: MetricWithAlarmSupport, props: DaysToExpiryThreshold, disambiguator?: string) {
    ...
    addIteratorMaxAgeAlarm(metric: MetricWithAlarmSupport, props: MaxAgeThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
    ...
    addDaysSinceUpdateAlarm(metric: MetricWithAlarmSupport, props: DaysSinceUpdateThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
