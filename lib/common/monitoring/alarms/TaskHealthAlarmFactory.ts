...
export class TaskHealthAlarmFactory {
    ...
    addHealthyTaskCountAlarm(metric: MetricWithAlarmSupport, props: HealthyTaskCountThreshold, disambiguator?: string) {
    ...
    addUnhealthyTaskCountAlarm(metric: MetricWithAlarmSupport, props: UnhealthyTaskCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
    ...
    addHealthyTaskPercentAlarm(metric: MetricWithAlarmSupport, props: HealthyTaskPercentThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.LESS_THAN_THRESHOLD,
            ...props,
    ...
    addRunningTaskCountAlarm(metric: MetricWithAlarmSupport, props: RunningTaskCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addRunningTaskRateAlarm(metric: MetricWithAlarmSupport, props: RunningTaskRateThreshold, disambiguator?: string) {
        ...
        return this.alarmFactory.addAlarm(metric, {
            ...
            alarmDedupeStringSuffix: this.alarmFactory.shouldUseDefaultDedupeForError ? "AnyError" : alarmNameSuffix,
            alarmDescription: "Running task rate is too high.",
        });
    }

    addMinRunningTaskCountAlarm(metric: MetricWithAlarmSupport, props: MinRunningTaskCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.LESS_THAN_THRESHOLD,
            ...props,
    ...
    addAvailabilityAlarm(metric: MetricWithAlarmSupport, props: AvailabilityThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.LESS_THAN_THRESHOLD,
            ...props,
