...
export class ConnectionAlarmFactory {
    ...
    addMinConnectionCountAlarm(metric: MetricWithAlarmSupport, props: LowConnectionCountThreshold, disambiguator?: string) {
    ...
    addMaxConnectionCountAlarm(metric: MetricWithAlarmSupport, props: HighConnectionCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
