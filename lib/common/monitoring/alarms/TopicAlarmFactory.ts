...
export class TopicAlarmFactory {
    ...
    addMinMessagesPublishedAlarm(metric: MetricWithAlarmSupport, props: LowMessagesPublishedThreshold, disambiguator?: string) {
    ...
    addMaxMessagesPublishedAlarm(metric: MetricWithAlarmSupport, props: HighMessagesPublishedThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
    ...
    addMessageNotificationsFailedAlarm(metric: MetricWithAlarmSupport, props: NotificationsFailedThreshold, disambiguator?: string) {
