...
export class LatencyAlarmFactory {
    ...
    addLatencyAlarm(
        ...
        const alarmNameSuffix = ["Latency", latencyType, additionalAlarmNameSuffix].filter((i) => i !== undefined).join("-");
        ...
        return this.alarmFactory.addAlarm(metric, {
            ...
            alarmDedupeStringSuffix: this.alarmFactory.shouldUseDefaultDedupeForLatency ? "AnyLatency" : alarmNameSuffix,
    ...
    addIntegrationLatencyAlarm(
        ...
        const alarmNameSuffix = ["IntegrationLatency", latencyType, additionalAlarmNameSuffix].filter((i) => i !== undefined).join("-");
    ...
    addDurationAlarm(
        ...
        const alarmNameSuffix = ["Duration", latencyType, additionalAlarmNameSuffix].filter((i) => i !== undefined).join("-");
        ...
        return this.alarmFactory.addAlarm(metric, {
            ...
            alarmNameSuffix,
            // we will dedupe any kind of latency issue to the same ticket
            alarmDedupeStringSuffix: this.alarmFactory.shouldUseDefaultDedupeForLatency ? "AnyDuration" : alarmNameSuffix,
    ...
    addJvmGarbageCollectionDurationAlarm(
        ...
        const alarmNameSuffix = ["Garbage-Collection-Time", latencyType, additionalAlarmNameSuffix]
