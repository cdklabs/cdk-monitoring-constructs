...
export class OpenSearchClusterAlarmFactory {
    ...
    addClusterStatusAlarm(metric: MetricWithAlarmSupport, props: OpenSearchClusterStatusCustomization, disambiguator?: string) {
    ...
    addClusterNodeCountAlarm(metric: MetricWithAlarmSupport, props: OpenSearchClusterNodesThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.BREACHING,
    ...
    addKmsKeyErrorAlarm(metric: MetricWithAlarmSupport, props: OpenSearchKmsKeyErrorThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.BREACHING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addKmsKeyInaccessibleAlarm(metric: MetricWithAlarmSupport, props: OpenSearchKmsKeyInaccessibleThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.BREACHING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
