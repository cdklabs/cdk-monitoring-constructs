...
export class UsageAlarmFactory {
    ...
    addMinUsageCountAlarm(percentMetric: MetricWithAlarmSupport, props: MinUsageCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.LESS_THAN_THRESHOLD,
            ...props,
            disambiguator,
    ...
    addMaxCpuUsagePercentAlarm(
        ...
        const alarmNameSuffix: string = usageType === undefined ? "CPU-Usage" : `${usageType}-CPU-Usage`;
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
    ...
    addMaxMasterCpuUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxMemoryUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.addMemoryUsagePercentAlarm(percentMetric, props, UsageType.MAX, disambiguator);
    }

    addMemoryUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, usageType: UsageType, disambiguator?: string) {
        const alarmNameSuffix: string = usageType === UsageType.MAX ? "Memory-Usage" : `${usageType}-Memory-Usage`;
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxMasterMemoryUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxDiskUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxHeapMemoryAfterGCUsagePercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxFileDescriptorPercentAlarm(percentMetric: MetricWithAlarmSupport, props: UsageThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxThreadCountUsageAlarm(percentMetric: MetricWithAlarmSupport, props: UsageCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(percentMetric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
