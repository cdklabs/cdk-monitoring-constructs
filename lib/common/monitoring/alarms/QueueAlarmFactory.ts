...
export class QueueAlarmFactory {
    ...
    addMinQueueMessageCountAlarm(metric: MetricWithAlarmSupport, props: MinMessageCountThreshold, disambiguator?: string) {
    ...
    addMaxQueueMessageCountAlarm(metric: MetricWithAlarmSupport, props: MaxMessageCountThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
    ...
    addMaxQueueMessageAgeAlarm(metric: MetricWithAlarmSupport, props: MaxMessageAgeThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
            treatMissingData: props.treatMissingDataOverride ?? TreatMissingData.MISSING,
            comparisonOperator: props.comparisonOperatorOverride ?? ComparisonOperator.GREATER_THAN_THRESHOLD,
            ...props,
    ...
    addMaxQueueTimeToDrainMessagesAlarm(metric: MetricWithAlarmSupport, props: MaxTimeToDrainThreshold, disambiguator?: string) {
        return this.alarmFactory.addAlarm(metric, {
