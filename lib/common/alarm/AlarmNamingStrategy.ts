import {DoNotModifyDedupeString, IAlarmDedupeStringProcessor} from "./IAlarmDedupeStringProcessor";
...
export class AlarmNamingStrategy implements IAlarmNamingStrategy {
    ...
    constructor(globalPrefix: string, localPrefix: string, dedupeStringStrategy?: IAlarmDedupeStringProcessor) {
        ...
        this.dedupeStringStrategy = dedupeStringStrategy ?? new DoNotModifyDedupeString();
    }
    ...
    getName(props: AlarmNamingInput) {
        ...
        const parts: string[] = [this.globalPrefix, this.localPrefix, props.alarmNameSuffix];
    ...
    getDedupeString(props: AlarmNamingInput) {
        ...
        if (props.alarmDedupeStringSuffix) {
            ...
            const parts = [this.globalPrefix, this.localPrefix, props.alarmDedupeStringSuffix];
