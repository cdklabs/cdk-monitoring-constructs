...
export class AutoScalingGroupMetricFactory {
    ...
    metricGroupDesiredCapacity() {
        return this.createMetric("GroupDesiredCapacity", "Desired", MetricStatistic.AVERAGE);
    }
    ...
    metricGroupInServiceInstances() {
        return this.createMetric("GroupInServiceInstances", "InService", MetricStatistic.AVERAGE);
    }
    ...
    metricGroupPendingInstances() {
        return this.createMetric("GroupPendingInstances", "Pending", MetricStatistic.AVERAGE);
    }
    ...
    metricGroupStandbyInstances() {
        return this.createMetric("GroupStandbyInstances", "Standby", MetricStatistic.AVERAGE);
    }
    ...
    metricGroupTerminatingInstances() {
        return this.createMetric("GroupTerminatingInstances", "Terminating", MetricStatistic.AVERAGE);
    }
    ...
    metricGroupTotalInstances() {
        return this.createMetric("GroupTotalInstances", "Total", MetricStatistic.AVERAGE);
    }

    private createMetric(metricName: string, label: string, statistic: MetricStatistic) {
