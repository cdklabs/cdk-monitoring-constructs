...
class AutoScalingGroupStrategy implements IEC2MetricFactoryStrategy {
    ...
    createMetrics(metricFactory: MetricFactory, metricName: string, statistic: MetricStatistic) {
        return [
...
function resolveDimensions(autoScalingGroup?: IAutoScalingGroup, instanceId?: string): DimensionsMap {
...
function resolveStrategy(props: EC2MetricFactoryProps): IEC2MetricFactoryStrategy {
