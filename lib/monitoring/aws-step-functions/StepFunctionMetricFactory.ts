...
export class StepFunctionMetricFactory {
    ...
    metricExecutionTimeP99InMillis() {
        return this.metricFactory.createMetric("ExecutionTime", MetricStatistic.P99, "P99", this.dimensionsMap, undefined, Namespace);
    }

    metricExecutionTimeP90InMillis() {
        return this.metricFactory.createMetric("ExecutionTime", MetricStatistic.P90, "P90", this.dimensionsMap, undefined, Namespace);
    }

    metricExecutionTimeP50InMillis() {
        return this.metricFactory.createMetric("ExecutionTime", MetricStatistic.P50, "P50", this.dimensionsMap, undefined, Namespace);
    }

    metricExecutionsFailed() {
        return this.metricFactory.createMetric("ExecutionsFailed", MetricStatistic.SUM, "Failed", this.dimensionsMap, undefined, Namespace);
    }
