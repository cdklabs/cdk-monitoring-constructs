...
import {StepFunctionActivityMetricFactory, StepFunctionActivityMetricFactoryProps} from "./StepFunctionActivityMetricFactory";
import {
    BaseMonitoringProps,
    CountAxisFromZero,
...
export class StepFunctionActivityMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: StepFunctionActivityMonitoringProps) {
        ...
        const metricFactory = new StepFunctionActivityMetricFactory(scope.createMetricFactory(), props);
        ...
        this.failedActivitiesRateMetric = metricFactory.metricActivitiesFailedRate();
        this.heartbeatTimedOutActivitiesMetrics = metricFactory.metricActivitiesHeartbeatTimedOut();
