...
import {HealthyMetricColor, MetricFactory, MetricStatistic, UnhealthyMetricColor} from "../../common";
 ...
 */
export class ApplicationLoadBalancerMetricFactory implements ILoadBalancerMetricFactory {
