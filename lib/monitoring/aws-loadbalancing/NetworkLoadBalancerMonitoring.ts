...
export class NetworkLoadBalancerMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: NetworkLoadBalancerMonitoringProps) {
        ...
        this.metricFactory = new NetworkLoadBalancerMetricFactory(scope.createMetricFactory(), props);
        this.healthyTaskCountMetric = this.metricFactory.metricHealthyTaskCount();
        this.unhealthyTaskCountMetric = this.metricFactory.metricUnhealthyTaskCount();
        this.healthyTaskPercentMetric = this.metricFactory.metricHealthyTaskInPercent();
        this.activeTcpFlowCountMetric = this.metricFactory.metricActiveConnectionCount();
