...
export class AppSyncMetricFactory {
    ...
    metricRequestCount() {
        return this.metricFactory.createMetric("Latency", MetricStatistic.N, "Requests", this.dimensionsMap, undefined, Namespace);
    }

    metricLatencyP50InMillis() {
        return this.metricFactory.createMetric("Latency", MetricStatistic.P50, "P50", this.dimensionsMap, undefined, Namespace);
    }

    metricLatencyP90InMillis() {
        return this.metricFactory.createMetric("Latency", MetricStatistic.P90, "P90", this.dimensionsMap, undefined, Namespace);
    }

    metricLatencyP99InMillis() {
        return this.metricFactory.createMetric("Latency", MetricStatistic.P99, "P99", this.dimensionsMap, undefined, Namespace);
    }

    metric4XXErrorCount() {
        return this.metricFactory.createMetric("4XXError", MetricStatistic.SUM, "4XX Error", this.dimensionsMap, undefined, Namespace);
    }
    ...
    metric5XXFaultCount() {
        return this.metricFactory.createMetric("5XXError", MetricStatistic.SUM, "5XX Fault", this.dimensionsMap, undefined, Namespace);
    }
