...
export class DynamoTableGlobalSecondaryIndexMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: DynamoTableGlobalSecondaryIndexMonitoringProps) {
        ...
        const metricFactory = new DynamoTableGlobalSecondaryIndexMetricFactory(scope.createMetricFactory(), props);
        ...
        this.indexConsumedWriteUnitsMetric = metricFactory.metricIndexConsumedWriteUnitsMetric();
        ...
        this.indexThrottleCountMetric = metricFactory.metricThrottledIndexRequestCount();
    ...
    protected createWriteCapacityWidget(width: number, height: number) {
        return new GraphWidget({
            ...
            left: [this.consumedWriteUnitsMetric, this.provisionedWriteUnitsMetric, this.indexConsumedWriteUnitsMetric],
            leftYAxis: CountAxisFromZero,
        });
    }
    ...
    protected createThrottlesWidget(width: number, height: number) {
        return new GraphWidget({
            ...
            height,
            title: "Throttles",
            left: [this.readThrottleCountMetric, this.writeThrottleCountMetric, this.indexThrottleCountMetric],
            leftYAxis: CountAxisFromZero,
