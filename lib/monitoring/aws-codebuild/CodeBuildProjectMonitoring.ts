...
import {CodeBuildProjectMetricFactory, CodeBuildProjectMetricFactoryProps} from "./CodeBuildProjectMetricFactory";
import {
    BaseMonitoringProps,
    CountAxisFromZero,
...
export class CodeBuildProjectMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: CodeBuildProjectMonitoringProps) {
        ...
        this.projectUrl = scope.createAwsConsoleUrlFactory().getCodeBuildProjectUrl(props.project.projectName);
        ...
        const metricFactory = new CodeBuildProjectMetricFactory(scope.createMetricFactory(), props);
        ...
        this.durationP99InSecondsMetric = metricFactory.metricDurationP99InSeconds();
        this.durationP90InSecondsMetric = metricFactory.metricDurationP90InSeconds();
        this.durationP50InSecondsMetric = metricFactory.metricDurationP50InSeconds();
    ...
    widgets(): IWidget[] {
        return [this.createTitleWidget(), this.createBuildCountsWidget(), this.createDurationWidget(), this.createFailedBuildRateWidget()];
    }
    ...
    createBuildCountsWidget() {
        return new GraphWidget({
            ...
            title: "Builds",
            left: [this.buildCountMetric, this.succeededBuildCountMetric, this.failedBuildCountMetric],
    ...
    createDurationWidget() {
        return new GraphWidget({
            ...
            height: DefaultGraphWidgetHeight,
            title: "Duration",
            left: [this.durationP50InSecondsMetric, this.durationP90InSecondsMetric, this.durationP99InSecondsMetric],
