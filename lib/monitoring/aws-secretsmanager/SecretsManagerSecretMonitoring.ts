...
import {SecretsManagerSecretMetricFactory, SecretsManagerSecretMetricFactoryProps} from "./SecretsManagerSecretMetricFactory";
import {
    AgeAlarmFactory,
    AlarmFactory,
    BaseMonitoringProps,
...
export class SecretsManagerSecretMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: SecretsManagerSecretMonitoringProps) {
        ...
        const metricFactory = new SecretsManagerSecretMetricFactory(scope.createMetricFactory(), props);
        this.daysSinceLastChangeMetric = metricFactory.metricDaysSinceLastChange();
        this.daysSinceLastRotationMetric = metricFactory.metricDaysSinceLastRotation();
    ...
    widgets(): IWidget[] {
        const widgets = [this.createTitleWidget(), this.createDaysSinceLastChangeWidget()];
