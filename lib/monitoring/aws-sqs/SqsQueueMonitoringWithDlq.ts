...
export class SqsQueueMonitoringWithDlq extends SqsQueueMonitoring {
    ...
    constructor(scope: MonitoringScope, props: SqsQueueMonitoringWithDlqProps) {
        ...
        const deadLetterMetricFactory = new SqsQueueMetricFactory(scope.createMetricFactory(), {
            ...props,
        ...
        this.deadLetterUrl = scope.createAwsConsoleUrlFactory().getSqsQueueUrl(props.deadLetterQueue.queueUrl);
        this.addDeadLetterQueueToSummaryDashboard = props.addDeadLetterQueueToSummaryDashboard ?? false;
        ...
        this.deadLetterQueueAlarmFactory = new QueueAlarmFactory(deadLetterAlarmFactory);
        this.deadLetterQueueVisibleMessagesMetric = deadLetterMetricFactory.metricApproximateVisibleMessageCount();
        this.deadLetterQueueIncomingMessagesMetric = deadLetterMetricFactory.metricIncomingMessageCount();
        this.deadLetterQueueOldestMessageAgeMetric = deadLetterMetricFactory.metricApproximateAgeOfOldestMessageInSeconds();
        ...
        for (const disambiguator in props.addDeadLetterQueueMaxSizeAlarm) {
            ...
            const createdAlarm = this.deadLetterQueueAlarmFactory.addMaxQueueMessageCountAlarm(
        ...
        for (const disambiguator in props.addDeadLetterQueueMaxMessageAgeAlarm) {
            ...
            const createdAlarm = this.deadLetterQueueAlarmFactory.addMaxQueueMessageAgeAlarm(
        ...
        for (const disambiguator in props.addDeadLetterQueueMaxIncomingMessagesAlarm) {
            ...
            const createdAlarm = this.deadLetterQueueAlarmFactory.addMaxQueueIncomingMessagesCountAlarm(
    ...
    summaryWidgets(): IWidget[] {
        ...
        return [
            ...
            this.createDeadLetterMessageCountWidget(HalfWidth, DefaultSummaryWidgetHeight),
            this.createDeadLetterMessageAgeWidget(HalfWidth, DefaultSummaryWidgetHeight),
        ];
    }
    ...
    widgets(): IWidget[] {
        return [
            ...
            this.createDeadLetterMessageCountWidget(HalfWidth, DefaultGraphWidgetHeight),
            this.createDeadLetterMessageAgeWidget(HalfWidth, DefaultGraphWidgetHeight),
        ];
    }
    ...
    protected createDeadLetterMessageCountWidget(width: number, height: number) {
        return new GraphWidget({
            ...
            left: [this.deadLetterQueueVisibleMessagesMetric, this.deadLetterQueueIncomingMessagesMetric],
