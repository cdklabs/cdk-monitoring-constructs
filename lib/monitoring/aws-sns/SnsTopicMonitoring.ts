...
import {SnsTopicMetricFactory, SnsTopicMetricFactoryProps} from "./SnsTopicMetricFactory";
import {
    BaseMonitoringProps,
    CountAxisFromZero,
...
export class SnsTopicMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: SnsTopicMonitoringProps) {
        ...
        this.topicUrl = scope.createAwsConsoleUrlFactory().getSnsTopicUrl(props.topic.topicArn);
        ...
        const metricFactory = new SnsTopicMetricFactory(scope.createMetricFactory(), props);
        ...
        this.messagesFailedMetric = metricFactory.metricNumberOfNotificationsFailed();
        ...
        for (const disambiguator in props.addMessageNotificationsFailedAlarm) {
            ...
            const createdAlarm = this.topicAlarmFactory.addMessageNotificationsFailedAlarm(
