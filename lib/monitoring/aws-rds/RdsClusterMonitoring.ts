...
import {RdsClusterMetricFactory, RdsClusterMetricFactoryProps} from "./RdsClusterMetricFactory";
import {
    BaseMonitoringProps,
...
export class RdsClusterMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: RdsClusterMonitoringProps) {
        ...
        const metricFactory = new RdsClusterMetricFactory(scope.createMetricFactory(), props);
        ...
        this.url = scope.createAwsConsoleUrlFactory().getRdsClusterUrl(metricFactory.clusterIdentifier);
