...
export class ElastiCacheClusterMetricFactory {
    ...
    metricMaxItemCount() {
        return this.metricFactory.createMetric("CurrItems", MetricStatistic.MAX, "Count", this.dimensionsMap, undefined, Namespace);
    }

    metricEvictions() {
        return this.metricFactory.createMetric("Evictions", MetricStatistic.SUM, "Evictions", this.dimensionsMap, undefined, Namespace);
    }
    ...
    metricAverageUnusedMemoryInBytes() {
        return this.metricFactory.createMetric("UnusedMemory", MetricStatistic.AVERAGE, "Unused", this.dimensionsMap, undefined, Namespace);
    }
    ...
    metricAverageSwapUsageInBytes() {
        return this.metricFactory.createMetric("SwapUsage", MetricStatistic.AVERAGE, "Swap", this.dimensionsMap, undefined, Namespace);
    }
    ...
    metricNetworkBytesIn() {
        return this.metricFactory.createMetric("NetworkBytesIn", MetricStatistic.SUM, "Bytes In", this.dimensionsMap, undefined, Namespace);
    }
