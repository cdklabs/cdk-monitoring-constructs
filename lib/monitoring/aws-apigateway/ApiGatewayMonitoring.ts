...
import {ApiGatewayMetricFactory, ApiGatewayMetricFactoryProps} from "./ApiGatewayMetricFactory";
import {
    AlarmFactory,
    BaseMonitoringProps,
    CountAxisFromZero,
...
export class ApiGatewayMonitoring extends Monitoring {
    ...
    constructor(scope: MonitoringScope, props: ApiGatewayMonitoringProps) {
        ...
        const metricFactory = new ApiGatewayMetricFactory(scope.createMetricFactory(), props);
