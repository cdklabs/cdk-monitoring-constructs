...
export class SingleWidgetDashboardSegment implements IDashboardSegment, IDynamicDashboardSegment {
    ...
    constructor(widget: IWidget, dashboardsToInclude?: string[]) {
        this.widget = widget;
        this.dashboardsToInclude = dashboardsToInclude ?? [DefaultDashboards.ALARMS, DefaultDashboards.DETAIL, DefaultDashboards.SUMMARY];
    }
