import {Column, Dashboard, DashboardProps, GraphWidget, IWidget, Row} from "aws-cdk-lib/aws-cloudwatch";
...
export class BitmapDashboard extends Dashboard {
    ...
    constructor(scope: Construct, id: string, props: DashboardProps) {
        ...
        this.bitmapRenderingSupport = new BitmapWidgetRenderingSupport(this, "BitmapRenderingSupport");
    }
