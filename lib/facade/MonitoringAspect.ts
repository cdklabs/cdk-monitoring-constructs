...
import {MonitoringAspectProps, MonitoringAspectType} from "./IMonitoringAspect";
...
export class MonitoringAspect implements IAspect {
    ...
    constructor(private readonly monitoringFacade: MonitoringFacade, private readonly props: MonitoringAspectProps = {}) {}
    ...
    private getMonitoringDetails<T>(aspectOptions?: MonitoringAspectType<T>): [boolean, T?] {
