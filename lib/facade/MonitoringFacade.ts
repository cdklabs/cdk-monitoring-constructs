...
import {IDynamicDashboardSegment, StaticSegmentDynamicAdapter} from "../dashboard/DynamicDashboardSegment";
...
export class MonitoringFacade extends MonitoringScope {
    ...
    createdMonitorings(): Monitoring[] {
        return this.createdSegments.filter((s) => s instanceof Monitoring).map((s) => s as Monitoring);
    }
     ...
     */
    addSegment(segment: IDashboardSegment, overrideProps?: MonitoringDashboardsOverrideProps) {
    ...
    addLargeHeader(text: string, addToSummary?: boolean, addToAlarm?: boolean) {
        this.addWidget(new HeaderWidget(text, HeaderLevel.LARGE), addToSummary ?? false, addToAlarm ?? false);
        return this;
    }

    addMediumHeader(text: string, addToSummary?: boolean, addToAlarm?: boolean) {
        this.addWidget(new HeaderWidget(text, HeaderLevel.MEDIUM), addToSummary ?? false, addToAlarm ?? false);
        return this;
    }

    addSmallHeader(text: string, addToSummary?: boolean, addToAlarm?: boolean) {
        this.addWidget(new HeaderWidget(text, HeaderLevel.SMALL), addToSummary ?? false, addToAlarm ?? false);
        return this;
    }
    ...
    monitorDynamoTableGlobalSecondaryIndex(props: DynamoTableGlobalSecondaryIndexMonitoringProps) {
    ...
    monitorFargateNetworkLoadBalancer(props: FargateNetworkLoadBalancerMonitoringProps) {
        const segment = new FargateServiceMonitoring(this, {
            ...props,
            fargateService: props.fargateService,
    ...
    monitorFargateApplicationLoadBalancer(props: FargateApplicationLoadBalancerMonitoringProps) {
        const segment = new FargateServiceMonitoring(this, {
            ...props,
            fargateService: props.fargateService,
    ...
    monitorEc2ApplicationLoadBalancer(props: Ec2ApplicationLoadBalancerMonitoringProps) {
        const segment = new Ec2ServiceMonitoring(this, {
            ...props,
            ec2Service: props.ec2Service,
            loadBalancer: props.applicationLoadBalancer,
    ...
    monitorQueueProcessingFargateService(props: QueueProcessingFargateServiceMonitoringProps) {
        getQueueProcessingFargateServiceMonitoring(this, props).forEach((segment) => this.addSegment(segment));
        return this;
    }

    monitorQueueProcessingEc2Service(props: QueueProcessingEc2ServiceMonitoringProps) {
        getQueueProcessingEc2ServiceMonitoring(this, props).forEach((segment) => this.addSegment(segment));
        return this;
    }
    ...
    monitorStepFunctionLambdaIntegration(props: StepFunctionLambdaIntegrationMonitoringProps) {
        const segment = new StepFunctionLambdaIntegrationMonitoring(this, props);
        this.addSegment(segment, props);
        return this;
    }

    monitorStepFunctionServiceIntegration(props: StepFunctionServiceIntegrationMonitoringProps) {
