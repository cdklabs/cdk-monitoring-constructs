import {awscdk, javascript, DependencyType} from "projen";
...
const project = new awscdk.AwsCdkConstructLibrary({
    ...
    depsUpgradeOptions: {
        workflowOptions: {
            schedule: javascript.UpgradeDependenciesSchedule.expressions(["0 0 * * 1"]),
        },
    },
...
["@aws-cdk/aws-apigatewayv2-alpha", "@aws-cdk/aws-redshift-alpha", "@aws-cdk/aws-synthetics-alpha"].forEach((dep) => {
